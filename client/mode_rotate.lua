...
function mode_rotate.rotate(prevWorldMouseX, prevWorldMouseY, worldMouseX, worldMouseY)
...
function mode_rotate.mousemoved(screenMouseX, screenMouseY, screenMouseDX, screenMouseDY, isTouch)
    if love.mouse.isDown(1) then
        ...
        mode_rotate.rotate(prevWorldMouseX, prevWorldMouseY, worldMouseX, worldMouseY)
    end
end
